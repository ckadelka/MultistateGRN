...
from boolforge import random_edge_list

from multistate_function import MultistateFunction
from multistate_network import MultistateNetwork
import utils
...
def random_linear_ms_function(
    ...
    f, var = utils.f_from_expression(expr, R)[0]
...
def random_MSN(N, in_degree = 2, base = 3, STRONGLY_CONNECTED = True, in_degree_distribution = 'const',
    ...
    return MultistateNetwork(F,B,I)
